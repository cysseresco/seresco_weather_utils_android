package seresco.weather.library.ui
...
import seresco.weather.library.data.repository.OnWeatherRepositoryReadyCallback
import seresco.weather.library.data.repository.WeatherRepository
import java.util.*
